...
After Git initialization, use `feature/*`, `fix/*`, `docs/*`, `test/*` or `chore/*` branches and reviewable PRs to `staging`. Never push directly to `staging` or `main`. Commit format is `type(scope): imperative summary`.
